...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='trans_attn',
                        help='Select model to use as generator. ProcessGAN or GAN with two transformers.')
    parser.add_argument('--data', type=str, default='bpic2012_a', help='Choose the dataset.')
